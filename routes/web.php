...
(
 ...
 /*------End-Acess Admin url -----*/
  ...
  Route::post('Admin/CitesStoreupdate', "adminController@CitesStoreupdate")->middleware('permission:تعديل-مدينة');
  Route::get('/Admin/UpdatCity/{id}', "adminController@Citesupdate")->middleware('permission:تعديل-مدينة');
  Route::get('/Admin/DeleteCity/{id}', "adminController@Citesdelete")->middleware('permission:حذف-مدينة');
